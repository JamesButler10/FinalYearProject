...
def draw_bbox(image, bboxes, info = False, counted_classes = None, show_label=True, allowed_classes=read_class_names(cfg.YOLO.CLASSES)):
    ...
    for i in range(num_boxes):
        ...
        if class_name not in allowed_classes:
            ...
            # Adding count per class to video output
